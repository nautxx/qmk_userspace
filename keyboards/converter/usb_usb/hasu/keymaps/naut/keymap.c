...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_INT3, KC_BSLS,  KC_INS,  KC_HOME, KC_PGUP,  KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,  KC_STOP, KC_AGIN,
    ...
    MO(1),   KC_LALT, KC_LGUI, KC_INT5, KC_LNG2,          KC_SPC,           KC_LNG1, KC_INT4, KC_INT2, KC_RGUI, KC_RALT, MO(1),   KC_RCTL,  KC_LEFT, KC_DOWN, KC_RGHT,  KC_P0,            KC_PDOT, KC_PENT,  KC_FIND, KC_CUT),
    ...
    KC_CAPS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,  _______, _______, _______,  _______, _______, _______, _______,  _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,                              _______, _______, _______, _______,  _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,           KC_VOLU,           _______, _______, _______, _______,  _______, _______,
    _______, _______, _______, _______, _______,          TG(2),            _______, _______, _______, _______, _______, _______, _______,  KC_MRWD, KC_VOLD, KC_MFFD,  _______,          _______, _______,  _______, _______),
