...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        MO(1),   KC_LALT, KC_LGUI,                   KC_SPC,                                      KC_RGUI, KC_NO,   KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [1] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                   KC_TRNS, KC_VOLU, KC_MPLY,
        KC_TRNS, KC_TRNS, KC_TRNS,                   TG(3),                                       KC_TRNS, KC_TRNS, KC_TRNS, KC_MRWD, KC_VOLD, KC_MFFD),
    ...
    [3] = LAYOUT_all(
        ...
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_NO,   KC_NO,
        KC_NO,   KC_NO,   KC_NO,                     KC_NO,                                                KC_NO,   KKC_NO,  KC_NO,   KC_NO,   KC_NO),
};
